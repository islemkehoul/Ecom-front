...
const Footer = () => {
  ...
  return (
    <footer className="bg-card text-card-foreground mt-auto hidden md:block transition-colors duration-200 border-t border-border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/about" className="hover:text-primary transition-colors">{t('footer.About us')}</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/products" className="hover:text-primary transition-colors">{t('footer.All Products')}</Link></li>
              <li><a href="#" className="hover:text-primary transition-colors">{t('footer.New Arrivals')}</a></li>
              <li><a href="#" className="hover:text-primary transition-colors">{t('footer.Featured')}</a></li>
            </ul>
          </div>
